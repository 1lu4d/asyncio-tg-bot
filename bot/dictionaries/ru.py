strings = {
    ...
    "HELP_TEXT": (
        ...
        "После этого можешь скидывать картинку с подписью и даже больше, можешь переслать боту сразу пачку подписанных картинок и они все пойдут к <b>админам</b>\n\n"
        "Все одобренные 'слова' бот отправляет в канал для удобства (В описании бота ссылка)\n\n"
        "Если заметишь <b>баги</b> <i>глитчи</i> и всё <u>остальное</u> то пиши мне <tg-spoiler>@GigaKatze</tg-spoiler>\n\n"
